...
namespace ffdprspecifica_marche
{
    public partial class Form1 : Form
    {
        ...
        private void Carica()
        {
            ...
            String ConnString = @"Data Source=INFORMATICA201\INFORMATICA225;Initial Catalog = Auto;Integrated Security=True";
        ...
        private void CommandEspliciti(SqlConnection conn)
        {
            ...
            //------------------ INSERT COMMAND -----------------------------
            SqlCommand commInsertModelli = new SqlCommand("Insert into Marche(Marca, Città) values(@Marca, @Citta)", conn);
            ...
            ParamAdd(commInsertModelli, "@Citta", SqlDbType.NVarChar, 20, "Città");

            //registra il comando
            MarcheDataAdapter.InsertCommand = commInsertModelli;
           
            //------------------ UPDATE COMMAND ------------------------------
            SqlCommand commUpDateMarche = new SqlCommand("UPDATE Marche SET marca=@marca, Città=@citta WHERE Codice=@oldCodice", conn);

            //registrazione dei parametri per il comando UPDATE
            ParamAdd(commUpDateMarche, "@Marca", SqlDbType.NVarChar, 20, "Marca");
            ParamAdd(commUpDateMarche, "@Citta", SqlDbType.NVarChar, 20, "Città");
