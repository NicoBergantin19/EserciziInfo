...
namespace databaseAuto
{
    public partial class Auto : Form
    {
        ...
        private void openToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            con.ConnectionString = "Data Source=DESKTOP-0JNBS50;Initial Catalog=Tabella;Integrated Security=True";
            //con.ConnectionString = "Data Source=INFORMATICA214\\INFORMATICA225;Initial Catalog=Auto;Integrated Security=True";
            //con.ConnectionString = "Server=INFORMATICA201\\INFORMATICA225;Database=Car;Integrated Security=False;Persist Security Info=False; User ID=sa;Password=1"; //Persist Securety Info = False serve per rimuovere le credenziali di accesso dopo la connessione
            try
            {
                con.Open();
        ...
        private void cancellaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (con != null && con.State == ConnectionState.Open)
            {
                Cancella cancella = new Cancella(con);
                cancella.Show();
            }
            else
            {
        ...
        private void controllaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (con != null && con.State == ConnectionState.Open)
            {
                Controlla controlla = new Controlla(con);
                controlla.Show();
            }
            else
            {
